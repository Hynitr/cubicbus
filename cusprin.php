...
$sql = "SELECT * FROM fee WHERE `fee` = '$fee'";
$res = query($sql);
...
$ssl ="SELECT * from $fee WHERE `cusid` = '$data'";
$result = query($ssl);
...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                <b><?php echo $vfh['name'] ?> (<?php echo $vfh['admno'] ?>)</b><br />
                                <?php echo $vfh['class'] ?><br />
                                <?php echo $vfh['term']." - ".$vfh['ses'] ?> Session
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="details">
                <td><b><?php echo $vfh['mode']?></b></td>

                <td><?php echo date('l, F d, Y', strtotime($vfh['datepaid'])); ?></td>
            </tr>
            ...
            <tr class="item">
                <td><b><?php echo ucwords($fee) ?> (<?php echo $vfh['type'] ?>)</b></td>

                <td>₦<?php echo number_format($vfh['amt']) ?></td>
            </tr>
